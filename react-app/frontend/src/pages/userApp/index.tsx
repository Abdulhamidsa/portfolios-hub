  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <section className="relative h-[40vh] sm:h-[50vh] flex items-center justify-center">
        <div className="absolute inset-0  from-primary to-secondary opacity-50" />
      ...
      <section className="py-8 px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}></Dialog>
        </div>
      </section>
      <section className="py-8 px-4 bg-secondary">
